...
pkill -f .config/lemonbar/scripts/spotify.sh
pkill -f .config/lemonbar/scripts/spotify_buttons.sh
...
.config/lemonbar/scripts/battery.sh	  | lemonbar  -f $FONT  -f 'NotoSansMono Nerd Font' -g 80x30+1650+5 -B $BG&
...
.config/lemonbar/scripts/spotify.sh | lemonbar -f $FONT -f 'NotoSansMono Nerd Font' -g 170x30+110+5 -b -B $BG | sh &
.config/lemonbar/scripts/spotify_buttons.sh | lemonbar -f 'NotoSansMono Nerd Font' -g 100x30+10+5 -b -B $BG | sh &
